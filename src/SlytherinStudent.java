public class SlytherinStudent extends HogwartsStudent {
    ...
    public void compareSlytherin(SlytherinStudent slytherinStudent) {
        ...
        if (ability1 > ability2) {
            System.out.printf("%s лучший Слизеренец, чем %s (сумма балллов %d Vs. %d). %n",
                    getName(), slytherinStudent.getName(), ability1, ability2);
        } else if (ability2 > ability1) {
            System.out.printf("%s лучший Слизеренец, чем %s (сумма балллов %d Vs. %d). %n",
                    slytherinStudent.getName(), getName(), ability2, ability1);
        } else {
            System.out.printf("Слизеренец  %s такой же, как слизеренец %s (сумма баллов %d Vs. %d).%n",
                    getName(), slytherinStudent.getName(), ability1, ability2);
        }
    }
