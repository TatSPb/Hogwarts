public class HufflepuffStudent extends HogwartsStudent {
    ...
    public void compareHufflepuff(HufflepuffStudent hufflepuffStudent) {
        ...
        if (ability1 > ability2) {
            System.out.printf("%s лучший Пуффендуец, чем %s (сумма балллов %d Vs. %d). %n",
                    getName(), hufflepuffStudent.getName(), ability1, ability2);
        } else if (ability2 > ability1) {
            System.out.printf("%s лучший Пуффендуец, чем %s (сумма баллов %d Vs. %d). %n",
                    hufflepuffStudent.getName(), getName(), ability2, ability1);
        } else {
            System.out.printf("Пуффендуец  %s такой же, как пуффендуец %s (сумма баллов %d Vs. %d). %n",
                    getName(), hufflepuffStudent.getName(), ability1, ability2);
        }
    }
