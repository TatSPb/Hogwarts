public class GryffindorStudent extends HogwartsStudent {
    ...
    public void compareGryffindor(GryffindorStudent gryffindorStudent) {
        ...
        if (ability1 > ability2) {
            System.out.printf("%s лучший Гриффиндорец, чем %s (сумма баллов %d Vs. %d). %n",
                    getName(), gryffindorStudent.getName(), ability1, ability2);
        } else if (ability2 > ability1) {
            System.out.printf("%s лучший Гриффиндорец, чем %s (сумма баллов %d Vs. %d). %n",
                    gryffindorStudent.getName(), getName(), ability2, ability1);
        } else {
            System.out.printf("Гриффиндорец  %s такой же, как гриффиндорец %s (сумма баллов %d Vs. %d). %n",
                    getName(), gryffindorStudent.getName(), ability1, ability2);
        }
    }
