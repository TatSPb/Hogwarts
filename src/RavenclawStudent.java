public class RavenclawStudent extends HogwartsStudent {
    ...
    public void compareRavenclaw(RavenclawStudent ravenclawStudent) {
        ...
        if (ability1 > ability2) {
            System.out.printf("%s лучший Когтевранец, чем %s (сумма балллов %d Vs. %d). %n",
                    getName(), ravenclawStudent.getName(), ability1, ability2);
        } else if (ability2 > ability1) {
            System.out.printf("%s лучший Когтевранец, чем %s (сумма балллов %d Vs. %d). %n",
                    ravenclawStudent.getName(), getName(), ability2, ability1);
        } else {
            System.out.printf("Когтевранец  %s такой же, как когтевранец %s (сумма баллов %d Vs. %d)%n",
                    getName(), ravenclawStudent.getName(), ability1, ability2);
        }
    }
